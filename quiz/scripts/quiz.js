const QuizApp = {
  ...
  csvFiles: [
    { fileName: "data/webdev-1.csv", displayName: "Web: Web Development 1" },
    { fileName: "data/webdev-2.csv", displayName: "Web: Web Development 2" },
    { fileName: "data/cssintro.csv", displayName: "Web: CSS Intro 1" },
    { fileName: "data/cssflex.csv", displayName: "Web: CSS Flex 1" },
    { fileName: "data/javascript-1.csv", displayName: "Web: JavaScript 1" },
    { fileName: "data/ositcpip.csv", displayName: "Networking: OSI & TCP/IP" },
